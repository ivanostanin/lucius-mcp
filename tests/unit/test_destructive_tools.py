...
async def test_update_shared_step_confirmation() -> None:
    result = await update_shared_step(step_id=123, confirm=False, output_format="plain")
...
async def test_delete_shared_step_confirmation() -> None:
    result = await delete_shared_step(step_id=123, confirm=False, output_format="plain")
...
async def test_update_test_case_confirmation() -> None:
    result = await update_test_case(test_case_id=456, confirm=False, output_format="plain")
    assert "⚠️ Update requires confirmation" in result
...
async def test_link_shared_step_confirmation() -> None:
    result = await link_shared_step(test_case_id=456, shared_step_id=123, confirm=False, output_format="plain")
...
async def test_unlink_shared_step_confirmation() -> None:
    result = await unlink_shared_step(test_case_id=456, shared_step_id=123, confirm=False, output_format="plain")
...
async def test_delete_test_layer_confirmation() -> None:
    result = await delete_test_layer(layer_id=789, confirm=False, output_format="plain")
    assert "⚠️ Deletion requires confirmation" in result
...
async def test_delete_test_suite_confirmation() -> None:
    result = await delete_test_suite(suite_id=789, confirm=False, output_format="plain")
...
async def test_update_test_layer_confirmation() -> None:
    result = await update_test_layer(layer_id=789, name="New Name", confirm=False, output_format="plain")
    assert "⚠️ Update requires confirmation" in result
...
async def test_delete_test_layer_schema_confirmation() -> None:
    result = await delete_test_layer_schema(schema_id=111, confirm=False, output_format="plain")
    assert "⚠️ Deletion requires confirmation" in result
...
async def test_update_test_layer_schema_confirmation() -> None:
    result = await update_test_layer_schema(schema_id=111, confirm=False, output_format="plain")
    assert "⚠️ Update requires confirmation" in result
...
async def test_delete_custom_field_value_confirmation() -> None:
    result = await delete_custom_field_value(cfv_id=222, confirm=False, output_format="plain")
    assert "⚠️ Deletion requires confirmation" in result
...
async def test_update_custom_field_value_confirmation() -> None:
    result = await update_custom_field_value(cfv_id=222, name="New Value", confirm=False, output_format="plain")
    assert "⚠️ Update requires confirmation" in result
