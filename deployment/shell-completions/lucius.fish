...
complete -c lucius -n "__fish_seen_subcommand_from attachment" -a "prepare-download prepare_download" -d "Action"
...
complete -c lucius -n "__fish_seen_subcommand_from launch launches ln" -a "add-test-result-attachment add-test-step-attachment add_test_result_attachment add_test_step_attachment close create delete get list list-test-results list_test_results reopen rerun-test-results-manually rerun_test_results_manually start-manual-test-session start_manual_test_session submit-manual-test-results submit_manual_test_results" -d "Action"
...
complete -c lucius -n "__fish_seen_subcommand_from test-plan test-plans test_plan test_plans tp" -a "create delete list manage-content manage_content run update" -d "Action"
complete -c lucius -n "__fish_seen_subcommand_from test-result test-results test_result test_results tr" -a "get" -d "Action"
complete -c lucius -n "__fish_seen_subcommand_from test-suite test-suites test_suite test_suites ts" -a "assign-test-cases assign_test_cases create delete get-contents get_contents list" -d "Action"

# Common action options
complete -c lucius -n "__fish_seen_subcommand_from add-test-result-attachment add-test-step-attachment add_test_result_attachment add_test_step_attachment assign-test-cases assign_test_cases close create delete delete-archived delete-unused delete_archived delete_unused get get-contents get-custom-fields get_contents get_custom_fields link-test-case link_test_case list list-test-cases list-test-results list_test_cases list_test_results manage-content manage_content prepare-download prepare_download reopen rerun-test-results-manually rerun_test_results_manually run search start-manual-test-session start_manual_test_session submit-manual-test-results submit_manual_test_results unlink-test-case unlink_test_case update" -l args -s a -r -d "JSON arguments"
complete -c lucius -n "__fish_seen_subcommand_from add-test-result-attachment add-test-step-attachment add_test_result_attachment add_test_step_attachment assign-test-cases assign_test_cases close create delete delete-archived delete-unused delete_archived delete_unused get get-contents get-custom-fields get_contents get_custom_fields link-test-case link_test_case list list-test-cases list-test-results list_test_cases list_test_results manage-content manage_content prepare-download prepare_download reopen rerun-test-results-manually rerun_test_results_manually run search start-manual-test-session start_manual_test_session submit-manual-test-results submit_manual_test_results unlink-test-case unlink_test_case update" -l format -s f -r -x -a "json table plain csv" -d "Output format"
complete -c lucius -n "__fish_seen_subcommand_from add-test-result-attachment add-test-step-attachment add_test_result_attachment add_test_step_attachment assign-test-cases assign_test_cases close create delete delete-archived delete-unused delete_archived delete_unused get get-contents get-custom-fields get_contents get_custom_fields link-test-case link_test_case list list-test-cases list-test-results list_test_cases list_test_results manage-content manage_content prepare-download prepare_download reopen rerun-test-results-manually rerun_test_results_manually run search start-manual-test-session start_manual_test_session submit-manual-test-results submit_manual_test_results unlink-test-case unlink_test_case update" -l pretty -d "Pretty-print JSON output"
complete -c lucius -n "__fish_seen_subcommand_from add-test-result-attachment add-test-step-attachment add_test_result_attachment add_test_step_attachment assign-test-cases assign_test_cases close create delete delete-archived delete-unused delete_archived delete_unused get get-contents get-custom-fields get_contents get_custom_fields link-test-case link_test_case list list-test-cases list-test-results list_test_cases list_test_results manage-content manage_content prepare-download prepare_download reopen rerun-test-results-manually rerun_test_results_manually run search start-manual-test-session start_manual_test_session submit-manual-test-results submit_manual_test_results unlink-test-case unlink_test_case update" -l help -s h -d "Show action help"
