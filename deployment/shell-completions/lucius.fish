...
complete -c lucius -n "__fish_seen_subcommand_from auth; and not __fish_seen_subcommand_from status" -a "status" -d "Auth command"
...
complete -c lucius -n "__fish_seen_subcommand_from assign-test-cases assign_test_cases close create delete delete-archived delete-unused delete_archived delete_unused get get-custom-fields get_custom_fields link-test-case link_test_case list list-test-cases list_test_cases manage-content manage_content reopen search unlink-test-case unlink_test_case update" -l format -s f -r -x -a "json table plain" -d "Output format"
