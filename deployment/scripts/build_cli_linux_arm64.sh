#!/usr/bin/env bash
# Build CLI binary for Linux ARM64
...
echo "Building lucius CLI for Linux ARM64..."
...
# Note: This assumes building on a Linux ARM64 machine
# For cross-compilation, you'll need the appropriate toolchain
uv run nuitka \
    --standalone \
    --onefile \
...
echo "✓ Built: dist/cli/lucius-linux-arm64"
