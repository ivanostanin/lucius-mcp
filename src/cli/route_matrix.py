...
CANONICAL_ROUTE_MATRIX: dict[str, dict[str, str]] = {
    ...
    "launch": {
        ...
        "submit_manual_test_results": "submit_manual_test_results",
        "add_test_result_attachment": "add_test_result_attachment",
        "add_test_step_attachment": "add_test_step_attachment",
