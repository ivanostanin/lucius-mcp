...
class PageLaunchAttachmentRowDto(BaseModel):
    """
    PageLaunchAttachmentRowDto
    """ # noqa: E501
    content: Optional[List[LaunchAttachmentRowDto]] = None
    ...
    __properties: ClassVar[List[str]] = ["content", "empty", "first", "last", "number", "numberOfElements", "pageable", "size", "totalElements", "totalPages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [LaunchAttachmentRowDto.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "empty": obj.get("empty"),
            "first": obj.get("first"),
            "last": obj.get("last"),
