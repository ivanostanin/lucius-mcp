...
class TreeControllerV2Api:
    ...
    async def find_all48(
        ...
        _param = self._find_all48_serialize(
    ...
    @validate_call
    async def find_all48_with_http_info(
        self,
        project_id: StrictInt,
        with_archived: Optional[StrictBool] = None,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
    ...
    @validate_call
    async def find_all48_without_preload_content(
        self,
        project_id: StrictInt,
        with_archived: Optional[StrictBool] = None,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
    ...
    async def find_one38(
        ...
        _param = self._find_one38_serialize(
            id=id,
            with_archived=with_archived,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def find_one38_with_http_info(
        self,
        id: StrictInt,
        with_archived: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def find_one38_without_preload_content(
        self,
        id: StrictInt,
        with_archived: Optional[StrictBool] = None,
        _request_timeout: Union[
