...
class TestResultFlatControllerApi:
    ...
    async def get_test_cases1(
        ...
        _param = self._get_test_cases1_serialize(
            launch_id=launch_id,
            search=search,
            filter_id=filter_id,
            page=page,
    ...
    @validate_call
    async def get_test_cases1_with_http_info(
        self,
        launch_id: StrictInt,
        search: Optional[StrictStr] = None,
        filter_id: Optional[StrictInt] = None,
    ...
    @validate_call
    async def get_test_cases1_without_preload_content(
        self,
        launch_id: StrictInt,
        search: Optional[StrictStr] = None,
        filter_id: Optional[StrictInt] = None,
    ...
    def _get_test_cases1_serialize(
        self,
        launch_id,
        search,
        filter_id,
