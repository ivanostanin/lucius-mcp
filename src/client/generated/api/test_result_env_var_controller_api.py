...
class TestResultEnvVarControllerApi:
    ...
    async def get_env_var_values(
        ...
        _param = self._get_env_var_values_serialize(
    ...
    @validate_call
    async def get_env_var_values_with_http_info(
        self,
        test_result_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_env_var_values_without_preload_content(
        self,
        test_result_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_env_var_values_serialize(
        self,
        test_result_id,
        _request_auth,
        _content_type,
