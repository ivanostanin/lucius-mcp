...
class TestResultTreeControllerV2Api:
    ...
    async def get_tree_entities(
        ...
        _param = self._get_tree_entities_serialize(
            launch_id=launch_id,
            tree_id=tree_id,
            search=search,
            filter_id=filter_id,
    ...
    @validate_call
    async def get_tree_entities_with_http_info(
        self,
        launch_id: StrictInt,
        tree_id: StrictInt,
        search: Optional[StrictStr] = None,
    ...
    @validate_call
    async def get_tree_entities_without_preload_content(
        self,
        launch_id: StrictInt,
        tree_id: StrictInt,
        search: Optional[StrictStr] = None,
    ...
    def _get_tree_entities_serialize(
        self,
        launch_id,
        tree_id,
        search,
