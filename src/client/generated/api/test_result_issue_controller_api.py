...
class TestResultIssueControllerApi:
    ...
    async def set_issues(
        ...
        _param = self._set_issues_serialize(
            test_result_id=test_result_id,
            issue_dto=issue_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def set_issues_with_http_info(
        self,
        test_result_id: StrictInt,
        issue_dto: List[IssueDto],
        _request_timeout: Union[
    ...
    @validate_call
    async def set_issues_without_preload_content(
        self,
        test_result_id: StrictInt,
        issue_dto: List[IssueDto],
        _request_timeout: Union[
