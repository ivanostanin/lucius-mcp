...
class TestResultFixtureControllerApi:
    ...
    async def get_fixtures(
        ...
        _param = self._get_fixtures_serialize(
    ...
    @validate_call
    async def get_fixtures_with_http_info(
        self,
        test_result_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_fixtures_without_preload_content(
        self,
        test_result_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_fixtures_attachments(
        self,
        test_result_id: StrictInt,
        ...
        _param = self._get_fixtures_attachments_serialize(
            test_result_id=test_result_id,
            page=page,
            size=size,
            sort=sort,
    ...
    @validate_call
    async def get_fixtures_attachments_with_http_info(
        self,
        test_result_id: StrictInt,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
    ...
    @validate_call
    async def get_fixtures_attachments_without_preload_content(
        self,
        test_result_id: StrictInt,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
    ...
    def _get_fixtures_attachments_serialize(
        self,
        test_result_id,
        page,
        size,
